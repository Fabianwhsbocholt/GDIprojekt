...
// Diese Klasse dient nur Testzwecken, die hier dargestellte Funktionalit�t soll
// �ber eine graphische Benutzungsoberfl�che realisiert werden
// Gestartet wird das Programm dann �ber die Klasse "WM2018mainGUI.java"
...
public class WM2018main
{
	public static void main (String[] args)
	{
		...
		{
			// Die Konfigurationsdaten konnten gelesen werden, wir k�nnen das
			...
			// Anlegen der ben�tigten Tabellen
