...
public class WMHandler implements EventHandler
{
	...
	public static void spielplanAusgabe(WM2018 mainapp, TextArea ausgabe)
	{
		...
		//Funktion fÃ¼r datum umwandeln aus der Klasse Hilfsfunktionen
	...
	public static void ergebnisseAusgeben(WM2018 mainapp, TextArea ausgabe) 
	{
		...
		ausgabe.appendText(" Spielmodus \t  Heimmanschaft - Gastmanschaft \t Halbzeit \t Regul. Spielz. \t Verlï¿½ngerung \t Elfmeter \t Gelbe Karten \t Rote Katen \n");
		//System.out.println(" Spielmodus \t  Heimmanschaft - Gastmanschaft \t Halbzeit \t Regul. Spielz. \t Verlï¿½ngerung \t Elfmeter \t Gelbe Karten \t Rote Katen");;
